...
using QLBanSach.DAO;
using QLBanSach.DAO._NguoiDung;
using QLBanSach.DTO;
...
namespace QLBanSach.Controllers
{
    ...
    {
        public ConnectClass cc4 = new ConnectClass();
        // GET: Nguoidung
        ...
        [HttpPost]
        public ActionResult Dangnhap(FormCollection collection,KHACHHANG khachhang)
        {
            var tendn = collection["TenDN"];
            var matkhau = collection["MatKhau"];
            ...
            else
            {
                ...
                else
                {
                    ...
                    KHACHHANG kh = cc4.GetKHACHHANG(khachhang);
                    if (kh != null)
                    {
